...
urlpatterns = [
    ...
    path('config/import/', views.ConfigImportView.as_view(), name='config-import'),
    path('simulate/', views.SimulationView.as_view(), name='simulate'),
    path('validate/', views.ValidateTopologyView.as_view(), name='validate'),
    ...
    path('<int:systemId>/<int:version>/download-sysml/', views.DownloadSysMLView.as_view(), name='download-sysml'), #TODO
    path('<int:systemId>/rename-system/', views.RenameSystemView.as_view(), name='rename-system'),
